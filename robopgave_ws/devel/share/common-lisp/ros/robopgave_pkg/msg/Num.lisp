...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robopgave_pkg-msg:<Num> is deprecated: use robopgave_pkg-msg:Num instead.")))

(cl:ensure-generic-function 'question-val :lambda-list '(m))
(cl:defmethod question-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robopgave_pkg-msg:question-val is deprecated.  Use robopgave_pkg-msg:question instead.")
  (question m))

(cl:ensure-generic-function 'answer-val :lambda-list '(m))
(cl:defmethod answer-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robopgave_pkg-msg:answer-val is deprecated.  Use robopgave_pkg-msg:answer instead.")
  (answer m))
